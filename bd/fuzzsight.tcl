...
################################################################
# This is a generated script based on design: fuzzsight
#
...
proc create_hier_cell_decoder { parentCell nameHier } {
  ...
  if { $parentCell eq "" || $nameHier eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2092 -severity "ERROR" "create_hier_cell_decoder() - Empty argument(s)!"}
     return
  }
  ...
  create_bd_pin -dir O -from 23 -to 0 o_atom_elements0
  create_bd_pin -dir O -from 4 -to 0 o_atom_nb0
  create_bd_pin -dir O o_exception_valid0
  create_bd_pin -dir O o_exception_pending0
  create_bd_pin -dir O -from 4 -to 0 o_exception_type0
  create_bd_pin -dir O -from 63 -to 0 o_pre_exception_addr0
  create_bd_pin -dir O o_atom_valid1
  create_bd_pin -dir O -from 63 -to 0 o_address_reg_0_1
  create_bd_pin -dir O -from 23 -to 0 o_atom_elements1
  create_bd_pin -dir O -from 4 -to 0 o_atom_nb1
  create_bd_pin -dir O o_exception_valid1
  create_bd_pin -dir O o_exception_pending1
  create_bd_pin -dir O -from 4 -to 0 o_exception_type1
  create_bd_pin -dir O -from 63 -to 0 o_pre_exception_addr1
  create_bd_pin -dir O o_atom_valid2
  create_bd_pin -dir O -from 63 -to 0 o_address_reg_0_2
  create_bd_pin -dir O -from 23 -to 0 o_atom_elements2
  create_bd_pin -dir O -from 4 -to 0 o_atom_nb2
  create_bd_pin -dir O o_exception_valid2
  create_bd_pin -dir O o_exception_pending2
  create_bd_pin -dir O -from 4 -to 0 o_exception_type2
  create_bd_pin -dir O -from 63 -to 0 o_pre_exception_addr2
  create_bd_pin -dir O o_atom_valid3
  ...
  create_bd_pin -dir O o_exception_valid3
  ...
  if { [catch {set etm_decoder_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $etm_decoder_0 eq "" } {
  ...
  if { [catch {set byte_stream_compactor_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $byte_stream_compactor_0 eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2096 -severity "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  ...
  if { [catch {set byte_stream_demux_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $byte_stream_demux_0 eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2096 -severity "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  ...
  if { [catch {set frame_deformatter_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $frame_deformatter_0 eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2096 -severity "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  ...
  if { [catch {set frame_generator_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $frame_generator_0 eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2096 -severity "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  ...
  [get_bd_pins o_address_reg_0_1]
  connect_bd_net -net etm_decoder_0_o_address_reg_0_2  [get_bd_pins etm_decoder_0/o_address_reg_0_2] \
  [get_bd_pins o_address_reg_0_2]
  connect_bd_net -net etm_decoder_0_o_address_reg_0_3  [get_bd_pins etm_decoder_0/o_address_reg_0_3] \
  [get_bd_pins o_address_reg_0_3]
  connect_bd_net -net etm_decoder_0_o_atom_elements0  [get_bd_pins etm_decoder_0/o_atom_elements0] \
  [get_bd_pins o_atom_elements0]
  connect_bd_net -net etm_decoder_0_o_atom_elements1  [get_bd_pins etm_decoder_0/o_atom_elements1] \
  [get_bd_pins o_atom_elements1]
  connect_bd_net -net etm_decoder_0_o_atom_elements2  [get_bd_pins etm_decoder_0/o_atom_elements2] \
  [get_bd_pins o_atom_elements2]
  connect_bd_net -net etm_decoder_0_o_atom_elements3  [get_bd_pins etm_decoder_0/o_atom_elements3] \
  [get_bd_pins o_atom_elements3]
  connect_bd_net -net etm_decoder_0_o_atom_nb0  [get_bd_pins etm_decoder_0/o_atom_nb0] \
  [get_bd_pins o_atom_nb0]
  connect_bd_net -net etm_decoder_0_o_atom_nb1  [get_bd_pins etm_decoder_0/o_atom_nb1] \
  [get_bd_pins o_atom_nb1]
  connect_bd_net -net etm_decoder_0_o_atom_nb2  [get_bd_pins etm_decoder_0/o_atom_nb2] \
  [get_bd_pins o_atom_nb2]
  connect_bd_net -net etm_decoder_0_o_atom_nb3  [get_bd_pins etm_decoder_0/o_atom_nb3] \
  [get_bd_pins o_atom_nb3]
  connect_bd_net -net etm_decoder_0_o_atom_valid0  [get_bd_pins etm_decoder_0/o_atom_valid0] \
  [get_bd_pins o_atom_valid0]
  connect_bd_net -net etm_decoder_0_o_atom_valid1  [get_bd_pins etm_decoder_0/o_atom_valid1] \
  [get_bd_pins o_atom_valid1]
  connect_bd_net -net etm_decoder_0_o_atom_valid2  [get_bd_pins etm_decoder_0/o_atom_valid2] \
  [get_bd_pins o_atom_valid2]
  connect_bd_net -net etm_decoder_0_o_atom_valid3  [get_bd_pins etm_decoder_0/o_atom_valid3] \
  [get_bd_pins o_atom_valid3]
  connect_bd_net -net etm_decoder_0_o_exception_pending0  [get_bd_pins etm_decoder_0/o_exception_pending0] \
  [get_bd_pins o_exception_pending0]
  connect_bd_net -net etm_decoder_0_o_exception_pending1  [get_bd_pins etm_decoder_0/o_exception_pending1] \
  [get_bd_pins o_exception_pending1]
  connect_bd_net -net etm_decoder_0_o_exception_pending2  [get_bd_pins etm_decoder_0/o_exception_pending2] \
  [get_bd_pins o_exception_pending2]
  connect_bd_net -net etm_decoder_0_o_exception_pending3  [get_bd_pins etm_decoder_0/o_exception_pending3] \
  [get_bd_pins o_exception_pending3]
  connect_bd_net -net etm_decoder_0_o_exception_type0  [get_bd_pins etm_decoder_0/o_exception_type0] \
  [get_bd_pins o_exception_type0]
  connect_bd_net -net etm_decoder_0_o_exception_type1  [get_bd_pins etm_decoder_0/o_exception_type1] \
  [get_bd_pins o_exception_type1]
  connect_bd_net -net etm_decoder_0_o_exception_type2  [get_bd_pins etm_decoder_0/o_exception_type2] \
  [get_bd_pins o_exception_type2]
  connect_bd_net -net etm_decoder_0_o_exception_type3  [get_bd_pins etm_decoder_0/o_exception_type3] \
  [get_bd_pins o_exception_type3]
  connect_bd_net -net etm_decoder_0_o_exception_valid0  [get_bd_pins etm_decoder_0/o_exception_valid0] \
  [get_bd_pins o_exception_valid0]
  connect_bd_net -net etm_decoder_0_o_exception_valid1  [get_bd_pins etm_decoder_0/o_exception_valid1] \
  [get_bd_pins o_exception_valid1]
  connect_bd_net -net etm_decoder_0_o_exception_valid2  [get_bd_pins etm_decoder_0/o_exception_valid2] \
  [get_bd_pins o_exception_valid2]
  connect_bd_net -net etm_decoder_0_o_exception_valid3  [get_bd_pins etm_decoder_0/o_exception_valid3] \
  [get_bd_pins o_exception_valid3]
  connect_bd_net -net etm_decoder_0_o_pre_exception_addr0  [get_bd_pins etm_decoder_0/o_pre_exception_addr0] \
  [get_bd_pins o_pre_exception_addr0]
  connect_bd_net -net etm_decoder_0_o_pre_exception_addr1  [get_bd_pins etm_decoder_0/o_pre_exception_addr1] \
  [get_bd_pins o_pre_exception_addr1]
  connect_bd_net -net etm_decoder_0_o_pre_exception_addr2  [get_bd_pins etm_decoder_0/o_pre_exception_addr2] \
  [get_bd_pins o_pre_exception_addr2]
  ...
  [get_bd_pins byte_stream_demux_0/i_ids]
  connect_bd_net -net frame_deformatter_0_o_keep  [get_bd_pins frame_deformatter_0/o_keep] \
  [get_bd_pins byte_stream_demux_0/i_keep]
  connect_bd_net -net frame_deformatter_0_o_valid  [get_bd_pins frame_deformatter_0/o_valid] \
  [get_bd_pins byte_stream_demux_0/i_valid]
...
\
  ...
  # Create instance: fuzzsight_reset, and set properties
  set fuzzsight_reset [ create_bd_cell -type ip -vlnv xilinx.com:ip:proc_sys_reset:5.0 fuzzsight_reset ]

  # Create instance: decoder_stats_lut, and set properties
  set block_name decoder_stats_lut
  set block_cell_name decoder_stats_lut
  if { [catch {set decoder_stats_lut [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $decoder_stats_lut eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2096 -severity "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  ...
  if { [catch {set edge_extractor [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $edge_extractor eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2096 -severity "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  ...
  # Create instance: axi_lite_reset, and set properties
  set axi_lite_reset [ create_bd_cell -type ip -vlnv xilinx.com:ip:proc_sys_reset:5.0 axi_lite_reset ]
  ...
  # Create instance: bitmap_writer_bram, and set properties
  set block_name bitmap_writer_bram
  set block_cell_name bitmap_writer_bram
  if { [catch {set bitmap_writer_bram [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $bitmap_writer_bram eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2096 -severity "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  ...
  if { [catch {set bitmap_reader_bram [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $bitmap_reader_bram eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2096 -severity "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  ...
  connect_bd_intf_net -intf_net axi_smc_M00_AXI [get_bd_intf_pins axi_smc/M00_AXI] [get_bd_intf_pins axi_dma/S_AXI_LITE]
  ...
  connect_bd_net -net bitmap_reader_bram_0_bram_en  [get_bd_pins bitmap_reader_bram/bram_en] \
  ...
  [get_bd_pins bram/dina]
  connect_bd_net -net bitmap_writer_bram_0_bram_en  [get_bd_pins bitmap_writer_bram/bram_en] \
  [get_bd_pins bram/ena]
  connect_bd_net -net bitmap_writer_bram_0_bram_we  [get_bd_pins bitmap_writer_bram/bram_we] \
  ...
  [get_bd_pins bitmap_reader_bram/bram_dout]
  connect_bd_net -net decoder_o_address_reg_0_0  [get_bd_pins decoder/o_address_reg_0_0] \
  [get_bd_pins decoder_stats_lut/i_address_reg_0_0] \
  [get_bd_pins edge_extractor/i_address_reg_0_0]
  connect_bd_net -net decoder_o_address_reg_0_1  [get_bd_pins decoder/o_address_reg_0_1] \
  [get_bd_pins decoder_stats_lut/i_address_reg_0_1] \
  [get_bd_pins edge_extractor/i_address_reg_0_1]
  connect_bd_net -net decoder_o_address_reg_0_2  [get_bd_pins decoder/o_address_reg_0_2] \
  [get_bd_pins decoder_stats_lut/i_address_reg_0_2] \
  [get_bd_pins edge_extractor/i_address_reg_0_2]
  connect_bd_net -net decoder_o_address_reg_0_3  [get_bd_pins decoder/o_address_reg_0_3] \
  [get_bd_pins decoder_stats_lut/i_address_reg_0_3] \
  [get_bd_pins edge_extractor/i_address_reg_0_3]
  connect_bd_net -net decoder_o_atom_elements0  [get_bd_pins decoder/o_atom_elements0] \
  [get_bd_pins decoder_stats_lut/i_atom_elements0] \
  [get_bd_pins edge_extractor/i_atom_elements0]
  connect_bd_net -net decoder_o_atom_elements1  [get_bd_pins decoder/o_atom_elements1] \
  [get_bd_pins decoder_stats_lut/i_atom_elements1] \
  [get_bd_pins edge_extractor/i_atom_elements1]
  connect_bd_net -net decoder_o_atom_elements2  [get_bd_pins decoder/o_atom_elements2] \
  [get_bd_pins decoder_stats_lut/i_atom_elements2] \
  [get_bd_pins edge_extractor/i_atom_elements2]
  connect_bd_net -net decoder_o_atom_elements3  [get_bd_pins decoder/o_atom_elements3] \
  [get_bd_pins decoder_stats_lut/i_atom_elements3] \
  [get_bd_pins edge_extractor/i_atom_elements3]
  connect_bd_net -net decoder_o_atom_nb0  [get_bd_pins decoder/o_atom_nb0] \
  [get_bd_pins decoder_stats_lut/i_atom_nb0] \
  [get_bd_pins edge_extractor/i_atom_nb0]
  connect_bd_net -net decoder_o_atom_nb1  [get_bd_pins decoder/o_atom_nb1] \
  [get_bd_pins decoder_stats_lut/i_atom_nb1] \
  [get_bd_pins edge_extractor/i_atom_nb1]
  connect_bd_net -net decoder_o_atom_nb2  [get_bd_pins decoder/o_atom_nb2] \
  [get_bd_pins decoder_stats_lut/i_atom_nb2] \
  [get_bd_pins edge_extractor/i_atom_nb2]
  connect_bd_net -net decoder_o_atom_nb3  [get_bd_pins decoder/o_atom_nb3] \
  [get_bd_pins decoder_stats_lut/i_atom_nb3] \
  [get_bd_pins edge_extractor/i_atom_nb3]
  connect_bd_net -net decoder_o_atom_valid0  [get_bd_pins decoder/o_atom_valid0] \
  [get_bd_pins decoder_stats_lut/i_atom_valid0] \
  [get_bd_pins edge_extractor/i_atom_valid0]
  connect_bd_net -net decoder_o_atom_valid1  [get_bd_pins decoder/o_atom_valid1] \
  [get_bd_pins decoder_stats_lut/i_atom_valid1] \
  [get_bd_pins edge_extractor/i_atom_valid1]
  connect_bd_net -net decoder_o_atom_valid2  [get_bd_pins decoder/o_atom_valid2] \
  [get_bd_pins decoder_stats_lut/i_atom_valid2] \
  [get_bd_pins edge_extractor/i_atom_valid2]
  ...
  [get_bd_pins edge_extractor/i_exception_pending1]
  connect_bd_net -net decoder_o_exception_pending2  [get_bd_pins decoder/o_exception_pending2] \
  [get_bd_pins edge_extractor/i_exception_pending2]
  connect_bd_net -net decoder_o_exception_pending3  [get_bd_pins decoder/o_exception_pending3] \
  [get_bd_pins edge_extractor/i_exception_pending3]
  connect_bd_net -net decoder_o_exception_type0  [get_bd_pins decoder/o_exception_type0] \
  [get_bd_pins edge_extractor/i_exception_type0]
  connect_bd_net -net decoder_o_exception_type1  [get_bd_pins decoder/o_exception_type1] \
  [get_bd_pins edge_extractor/i_exception_type1]
  connect_bd_net -net decoder_o_exception_type2  [get_bd_pins decoder/o_exception_type2] \
  [get_bd_pins edge_extractor/i_exception_type2]
  connect_bd_net -net decoder_o_exception_type3  [get_bd_pins decoder/o_exception_type3] \
  [get_bd_pins edge_extractor/i_exception_type3]
  connect_bd_net -net decoder_o_exception_valid0  [get_bd_pins decoder/o_exception_valid0] \
  [get_bd_pins edge_extractor/i_exception_valid0]
  connect_bd_net -net decoder_o_exception_valid1  [get_bd_pins decoder/o_exception_valid1] \
  [get_bd_pins edge_extractor/i_exception_valid1]
  connect_bd_net -net decoder_o_exception_valid2  [get_bd_pins decoder/o_exception_valid2] \
  ...
  [get_bd_pins edge_extractor/i_pre_exception_addr1]
  connect_bd_net -net decoder_o_pre_exception_addr2  [get_bd_pins decoder/o_pre_exception_addr2] \
  [get_bd_pins edge_extractor/i_pre_exception_addr2]
  connect_bd_net -net decoder_o_pre_exception_addr3  [get_bd_pins decoder/o_pre_exception_addr3] \
  [get_bd_pins edge_extractor/i_pre_exception_addr3]
  connect_bd_net -net edge_extractor_0_o_empty  [get_bd_pins edge_extractor/o_empty] \
  [get_bd_pins bitmap_reader_bram/i_fifo_empty]
  connect_bd_net -net edge_extractor_0_o_index  [get_bd_pins edge_extractor/o_index] \
  [get_bd_pins bitmap_writer_bram/i_fifo_index]
  connect_bd_net -net edge_extractor_0_o_valid  [get_bd_pins edge_extractor/o_valid] \
  [get_bd_pins bitmap_writer_bram/i_fifo_valid]
  connect_bd_net -net proc_sys_reset_0_peripheral_aresetn  [get_bd_pins fuzzsight_reset/peripheral_aresetn] \
  ...
  [get_bd_pins fuzzsight_reset/slowest_sync_clk] \
  ...
  [get_bd_pins axi_lite_reset/slowest_sync_clk] \
  [get_bd_pins axi_smc_1/aclk1]
  connect_bd_net -net zynq_ultra_ps_pl_pl_resetn0  [get_bd_pins zynq_ultra_ps_pl/pl_resetn0] \
  [get_bd_pins fuzzsight_reset/ext_reset_in]
  connect_bd_net -net zynq_ultra_ps_pl_pl_resetn1  [get_bd_pins zynq_ultra_ps_pl/pl_resetn1] \
  [get_bd_pins axi_lite_reset/ext_reset_in]
  connect_bd_net -net zynq_ultra_ps_pl_ps_pl_tracedata  [get_bd_pins zynq_ultra_ps_pl/ps_pl_tracedata] \
  [get_bd_pins decoder/i_data]
  ...
  exclude_bd_addr_seg -offset 0xFF000000 -range 0x01000000 -target_address_space [get_bd_addr_spaces axi_dma/Data_S2MM] [get_bd_addr_segs zynq_ultra_ps_pl/SAXIGP2/HP0_LPS_OCM]
